...
public class CPUToolsFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        mMPDecision.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
        {
            ...
            {
                mShell.getSession().addCommand(((isChecked) ? "mount -o remount ,rw /system ; chmod 777 /system/bin/mpdecision; start mpdecision" : "mount -o remount ,rw /system ; chmod 664 /system/bin/mpdecision ; killall mpdecision; stop mpdecision") + " mpdecision");
            }
        });
