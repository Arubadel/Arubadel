...
import com.delos.sumit.arubadel.adapter.RomReleaseAdapter;
...
public class RomReleaseStable extends ListFragment
{
    private RomReleaseAdapter mAdapter;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState)
    {
        ...
        this.mAdapter = new RomReleaseAdapter(getActivity());
        ...
        new Thread()
        {
            ...
            public void run()
            {
                ...
                try
                {
                    ...
                    HttpRequest httpRequest = HttpRequest.get(Config.URL_ROM_STABLE_RELEASE);
